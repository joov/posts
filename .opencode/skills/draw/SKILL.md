---
name: draw
description: Create mermaid graphs to include in a post
license: MIT
...
Used after the plan is created and before writing the post. The plan should contain graph suggestions (labeled as "Graph 1", "Graph 2", etc.).
